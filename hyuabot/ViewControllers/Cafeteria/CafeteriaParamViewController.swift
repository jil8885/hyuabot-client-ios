...
class CafeteriaParamViewController: UIViewController {
    ...
    private lazy var okButton: UIButton? = {
        ...
        button.setTitle(String.localizedCafeteriaItem(resourceID: "search.option.ok"), for: .normal)
    ...
    private lazy var cancelButton: UIButton? = {
        var configuration = UIButton.Configuration.plain()
        let button = UIButton(configuration: configuration)
        button.setTitle(String.localizedCafeteriaItem(resourceID: "search.option.cancel"), for: .normal)
    ...
    @objc func okButtonTapped() {
        self.appDelegate.cafeteriaQueryParams.onNext(self.datePickerView.date)
