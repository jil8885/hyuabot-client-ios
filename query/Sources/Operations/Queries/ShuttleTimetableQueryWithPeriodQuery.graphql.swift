...
public class ShuttleTimetableQueryWithPeriodQuery: GraphQLQuery {
  public static let operationName: String = "ShuttleTimetableQueryWithPeriod"
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query ShuttleTimetableQueryWithPeriod($stop: String!, $period: String!, $tags: [String!]!) { shuttle(stop: [$stop], weekday: [true, false], period: [$period], tag: $tags) { __typename stop { __typename stopName tag { __typename tagID timetable { __typename time weekdays } } } params { __typename period } } }"#
    ))
