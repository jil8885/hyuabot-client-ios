...
public class SubwayTimetableDownQuery: GraphQLQuery {
  ...
  public static let operationDocument: ApolloAPI.OperationDocument = .init(
    definition: .init(
      #"query SubwayTimetableDownQuery($station: [String!]!) { subway(station: $station, start: "00:00") { __typename timetable { __typename down { __typename destinationID destinationName weekday time } } } }"#
    ))
